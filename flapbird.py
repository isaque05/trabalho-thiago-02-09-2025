...
IMAGEM_CANO = pygame.transform.scale2x(
    pygame.image.load(r"C:\Users\Marcelo\Documents\GitHub\Curso_Modulo_4\Programação\Projeto Jogo\imgs\pipe.png")
)
IMAGEM_CHAO = pygame.transform.scale2x(
    pygame.image.load(r"C:\Users\Marcelo\Documents\GitHub\Curso_Modulo_4\Programação\Projeto Jogo\imgs\base.png")
)
IMAGEM_BACKGROUND = pygame.transform.scale2x(
    pygame.image.load(r"C:\Users\Marcelo\Documents\GitHub\Curso_Modulo_4\Programação\Projeto Jogo\imgs\bg.png")
)
IMAGENS_PASSARO = [
    pygame.transform.scale2x(
        pygame.image.load(r"C:\Users\Marcelo\Documents\GitHub\Curso_Modulo_4\Programação\Projeto Jogo\imgs\bird1.png")
    ),
    pygame.transform.scale2x(
        pygame.image.load(r"C:\Users\Marcelo\Documents\GitHub\Curso_Modulo_4\Programação\Projeto Jogo\imgs\bird2.png")
    ),
    pygame.transform.scale2x(
        pygame.image.load(r"C:\Users\Marcelo\Documents\GitHub\Curso_Modulo_4\Programação\Projeto Jogo\imgs\bird3.png")
    ),
]
